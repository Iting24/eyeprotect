...
class EyeHealthAccessibilityService : AccessibilityService(), TextToSpeech.OnInitListener, LifecycleOwner {
    ...
    companion object {
        ...
        const val PREF_LIVE_LEFT_EYE_OPEN = "live_left_eye_open"
        const val PREF_LIVE_RIGHT_EYE_OPEN = "live_right_eye_open"
        const val PREF_LIVE_EYE_OPEN_MIN = "live_eye_open_min"
        const val PREF_LIVE_SLOUCH_SCORE = "live_slouch_score"
        const val PREF_LIVE_FACE_PITCH_DEG = "live_face_pitch_deg"
        ...
        const val PREF_LIVE_SQUINT_HOLD_MS = "live_squint_hold_ms"
        ...
        const val EXTRA_LIVE_LEFT_EYE_OPEN = "leftEyeOpen"
        const val EXTRA_LIVE_RIGHT_EYE_OPEN = "rightEyeOpen"
        const val EXTRA_LIVE_EYE_OPEN_MIN = "eyeOpenMin"
        const val EXTRA_LIVE_SLOUCH_SCORE = "slouchScore"
        const val EXTRA_LIVE_FACE_PITCH_DEG = "facePitchDeg"
        ...
        const val EXTRA_LIVE_SQUINT_HOLD_MS = "squintHoldMs"
