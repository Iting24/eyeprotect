...
class EyeHealthAccessibilityService : AccessibilityService(), TextToSpeech.OnInitListener, LifecycleOwner {
    ...
    companion object {
        ...
        const val PREF_LIVE_FACE_MATCHED = "live_face_matched"
        const val PREF_LIVE_IDENTITY_PAUSED = "live_identity_paused"
        ...
        const val EXTRA_LIVE_FACE_MATCHED = "faceMatchedActiveProfile"
        const val EXTRA_LIVE_IDENTITY_PAUSED = "identityPaused"
